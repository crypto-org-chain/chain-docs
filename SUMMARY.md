...
* [⛓️ Running Nodes](for-node-hosts/getting-started/README.md)
  ...
  * [Quicksync](for-node-hosts/getting-started/quicksync.md)
  * [Cronos POS Chain Mainnet: Running a Full Node](for-node-hosts/getting-started/mainnet/README.md)
    * [Upgrade Guide](for-node-hosts/getting-started/mainnet/upgrade-guide/README.md)
      * [The "V6" upgrade guide (v5.0.1 to v6.0.0-2) :](for-node-hosts/getting-started/mainnet/upgrade-guide/upgrade_guide_v4.md)
      * [The "V5" upgrade guide (v4.\* to v5.0.1) :](for-node-hosts/getting-started/mainnet/upgrade-guide/upgrade_guide_v4-1.md)
      * [The "V4" upgrade guide (v3.\* to v4.2.2) :](for-node-hosts/getting-started/mainnet/upgrade-guide/upgrade_guide_v4-2.md)
