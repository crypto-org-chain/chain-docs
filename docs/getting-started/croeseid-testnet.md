...
::: tip Remarks:
Since there was a network upgrade of `testnet-croeseid-2`, If you would like to build a fullnode will complete blockchain data from scratch, kindly follow this [guide](https://github.com/crypto-com/testnets/blob/main/testnet-croeseid-2/croeseid-v0.9.1-fullnode.md#running-a-fullnode-of-croeseid-testnet).
:::
