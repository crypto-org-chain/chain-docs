...
* The chain-maind `v8.0.0` - "V8" upgrade is proposed to be scheduled at the block height of `30,720,400` ( _Estimated time Tuesday, July 14 2026_, but this depends on the actual time taken when the blocks are being processed);
