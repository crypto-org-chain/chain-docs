...
**DO NOT UPGRADE to the binary `v4.2.2` before that suggested upgrade schedule and come across with the error message as described in** [**Step 0**](upgrade_guide_v4-3.md#step-0-dont-panic)**.** &#x20;
{% endhint %}
